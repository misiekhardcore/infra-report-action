...
class ArgoCdService extends types_1.Service {
    constructor(token, config) {
        ...
        this.fetchArgoCdAplications = (project) => __awaiter(this, void 0, void 0, function* () {
            return (0, fetchUrl_1.default)(`https://argocd.int.camunda.com/api/v1/applications?projects=${project}`, `Bearer ${this.token}`);
        });
        this.parseMessage = (application) => {
            return `${this.getApplicationStatus(application)} <https://argocd.int.camunda.com/applications/argocd/${application.metadata.name}|${application.metadata.name}>`;
        };
